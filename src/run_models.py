...
for epoch in range(config['num_epoch']):
    ...
    results.append((epoch, hit_ratio, ndcg))
    engine.save(config['alias'], epoch, hit_ratio, ndcg)
    
results_df = pd.DataFrame(results, columns=['Epoch','Hit Ratio','NDCG'])
results_df.to_csv("results/MLP_layer0_results.csv",index=False)