...
The pytorch version I used is 2.3.0, which is the latest version at the time of writing this report and it can be check the version by running the following code:
