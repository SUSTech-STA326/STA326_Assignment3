...
<img src="3models.svg" alt="Image1" width = "300px">

For the second task, I train MLP with different hidden layer size, and the results are shown in the following figure.

<img src="MLP.svg" alt="Image1" width = "300px">

Based on the information provided, with the number of layers increasing, the model's performance is improving. However, when the number of layers is larger than 4, the model's performance is not improving any more. So I think the number of layers should be set to 4.