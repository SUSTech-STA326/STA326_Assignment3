...
if __name__ == '__main__':
    ...
    # 回到这里
    for num_factors in [[64, 32, 16, 8], [128, 64, 32, 16], [256, 128, 64, 32], [512, 256, 128, 64]]:
        for m in ['MLP', 'NCF']:
            if m == 'GMF':
                if num_factors == [8]:
            ...
            if model is not None:
                ...
                for epoch in range(epochs):
                    ...
                    if epoch % verbose == 0:
                        ...
                        result = {
                            'Model': m, '# Factor': num_factors[-1], 'Iteration': epoch + 1,
    ...
    result_data.to_csv('result_factor' + '.csv', index=False)
